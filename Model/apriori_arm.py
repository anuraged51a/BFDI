...
#prompt to enter support and confidence values in percent
...
#"has_infrequent_subset" function to determine 
#if pruning is required to remove unfruitful candidates (c) using the Apriori property,
...
#"generate_association_rules" function to mine & print all the association rules
